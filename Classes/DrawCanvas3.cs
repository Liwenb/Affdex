...
{
   public class DrawCanvas3: System.Windows.Controls.Canvas
    {
        ...
        protected override void OnRender(System.Windows.Media.DrawingContext dc)
        {
            ...
            foreach (KeyValuePair<int, Affdex.Face> pair in Faces)
            {
                ...
                if (DrawMetrics)
                {
                   ...
                   // MySqlHelper.ExecuteDataTable("insert into AffdexTable(id,Anger,Contempt,Disgust,Fear,Engagement,Joy,Sadness,Surprise,Valence,test_Date) VALUES(101," + ee.Anger + "," + ee.Contempt + "," + ee.Disgust + "," + ee.Fear + "," + ee.Engagement + "," + ee.Joy + "," + ee.Sadness + "," + ee.Surprise + "," + ee.Valence + "," + DateTime.Now + ");", new MySqlParameter[] { });
                }
